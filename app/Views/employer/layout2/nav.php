 ...
 <div class="container">
  ...
  <div class="collapse navbar-collapse" id="mainNavbar">
   <ul class="navbar-nav text-center me-auto mb-2 mb-lg-0">
    ...
    <li class="nav-item">
     <a class="nav-link <?= ($current_url == base_url('/viar')) ? 'active' : '' ?>" href="<?= base_url('/viar') ?>"><?= lang('Nav.viar') ?> </a>
    </li>
    <li class="nav-item">
     <a class="nav-link <?= ($current_url == base_url('/shumus')) ? 'active' : '' ?>" href="<?= base_url('/shumus') ?>"> <?= lang('Nav.shumus') ?></a>
    </li>
    <li class="nav-item">
   ...
   <a href="/contact-us" class="btn cta-btn btn-primary ms-3"> <?= lang('Nav.contact_us_wa') ?>
    <i class="fa-brands fa-whatsapp me-2 text-white"></i></a>
