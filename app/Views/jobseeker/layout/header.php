...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-3 justify-content-between">
  <a class="navbar-brand" href="/jobseeker"><img src="<?= base_url('images/logo.png'); ?>" height="40px" width="35px" alt="logo" />Jobseeker Dashboard</a>
  ...
  <div class="d-flex align-items-center gap-3">
   ...
   <div class="dropdown">
    ...
    <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
     <img src="<?= base_url('uploads/jobseekers/' . $jobseekerImage) ?>" alt="Profile" class="rounded-circle me-2" width="32" height="32">
